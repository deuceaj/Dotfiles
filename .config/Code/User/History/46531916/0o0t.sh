...
sed -i -e 's/fg = .*/fg = #d81b60/g' $PDIR/colors.ini
sed -i -e 's/ac = .*/ac = #fffff/g' $PDIR/colors.ini
sed -i -e 's/bi = .*/bi = #dc404040/g' $PDIR/colors.ini
sed -i -e 's/be = .*/be = #dc404040/g' $PDIR/colors.ini
sed -i -e 's/mb = .*/mb = #039be5/g' $PDIR/colors.ini
sed -i -e 's/mgf = .*/mgf = #039be5/g' $PDIR/colors.ini
sed -i -e 's/mf = .*/mf = #039be5/g' $PDIR/colors.ini
# Restarting polybar
$LAUNCH1 &
$LAUNCH2 &
