...
if  [[ $1 = "-mode1" ]]; then
# Replacing colors
sed -i -e 's/bg = .*/bg = #80263238/g' $PDIR/colors.ini
sed -i -e 's/fg = .*/fg = #e5e5e5/g' $PDIR/colors.ini
sed -i -e 's/ac = .*/ac = #EC407A/g' $PDIR/colors.ini
sed -i -e 's/bi = .*/bi = #404040/g' $PDIR/colors.ini
sed -i -e 's/be = .*/be = #404040/g' $PDIR/colors.ini
sed -i -e 's/mb = .*/mb = #8000BCD4/g' $PDIR/colors.ini
sed -i -e 's/mgf = .*/mgf = #8000BCD4/g' $PDIR/colors.ini
