...
globalkeys = my_table.join(
    ...
    awful.key({ altkey, "Control" }, "e", function () awful.util.spawn( "code .config/awesome" ) end,
    ...
    awful.key({ modkey, altkey }, "space",         function ()  awful.util.spawn("rofi -combi-modi window,drun -show combi -modi combi") end,
        {description = "rofi", group = "gui apps"}),
    awful.key({ modkey, altkey }, "b", function () awful.util.spawn( "firefox-developer-edition" ) end,
        {description = "firefox" , group = "gui apps" }),
    awful.key({ modkey, altkey }, "x", function () awful.util.spawn( "kitty" ) end,
        {description = "kitty" , group = "gui apps" }),
    awful.key({ modkey, altkey }, "e", function () awful.util.spawn( "thunar" ) end,
        {description = "thunare" , group = "gui apps" }),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.spawn( terminal.." -e bash" ) end,
